...
const BUNDLE_IDS = {
  development: 'com.myexpoownerapp.development',
  preview: 'com.myexpoownerapp.preview',
  production: 'com.myexpoownerapp',
} as const;
...
const SCHEMES = {
  development: 'Myexpo-ownerApp',
  preview: 'Myexpo-ownerApp.preview',
  production: 'Myexpo-ownerApp',
} as const;

const NAME = 'Myexpo-ownerApp';
